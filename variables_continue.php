...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container my-3">
        ...
        <ul>
            <li>variable always start with $ sign</li>
            <li>variables cannot start with numbers like 2,3,4 , but you can do this one , Two, Three as name 0f variables </li>
            <li>Must start with a letter or an underscore character</li>
            <li>can only contain alphanumeric characters and underscores</li>
            <li>Don't write this like $name%  only from special characters underscore is allowed</li>
